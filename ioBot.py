...
class io:
        ...
        bot_answer = {
                'oi':f'{hourGreetings()}, tudo bem? Gostaria de consultar qual base de dados? Escolha um número ou digite o nome.',
                'olá':f'{hourGreetings()}, tudo bem? Gostaria de consultar qual base de dados? Escolha um número ou digite o nome.',
                'ola':f'{hourGreetings()}, tudo bem? Gostaria de consultar qual base abaixo? Escolha um número ou digite o nome.',
